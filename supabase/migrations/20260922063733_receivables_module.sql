...
revoke all on public.sales_contracts from public, anon;
revoke all on public.installments from public, anon;
revoke all on public.payments from public, anon;
revoke all on public.financial_audit_logs from public, anon;
